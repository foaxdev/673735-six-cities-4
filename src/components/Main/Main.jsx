...
export const Main = (props) => {
  ...
  const offersList = offers.map((offer, index) => <Apartment key={offer + index} offer={offer} onHeaderButtonClick={headerClickHandler} />);
      ...
      <div className="cities">
        <div className="cities__places-container container">
          <section className="cities__places places">
            ...
            <b className="places__found">{availableOffers} places to stay in Amsterdam</b>
